...
class CompanyEmailTemplateController extends Controller {
    ...
    public function store(Request $request) {
        ...
        if ($validator->fails()) {
            if ($request->ajax()) {
                ...
                return redirect()->route('company_email_template.create')
        ...
        if (!$request->ajax()) {
            return redirect()->route('company_email_template.index')->with('success', _lang('Saved Sucessfully'));
        } else {
    ...
    public function update(Request $request, $id) {
        ...
        if (!$request->ajax()) {
            return redirect()->route('company_email_template.index')->with('success', _lang('Updated Sucessfully'));
        } else {
