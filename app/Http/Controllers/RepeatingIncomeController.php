...
class RepeatingIncomeController extends Controller {
    ...
    public function get_table_data() {
        ...
        $transactions = RepeatTransaction::with("account")->with("income_type")
        ...
        return Datatables::eloquent($transactions)
            ...
            ->addColumn('action', function ($trans) {
                ...
                . '<a href="' . action('RepeatingIncomeController@edit', $trans['id']) . '" data-title="' . _lang('Update Income') . '" class="btn btn-warning btn-sm ajax-modal"><i class="ti-pencil-alt"></i></a> '
                . '<a href="' . action('RepeatingIncomeController@show', $trans['id']) . '" data-title="' . _lang('View Income') . '" class="btn btn-primary btn-sm ajax-modal"><i class="ti-eye"></i></a> '
                . csrf_field()
    ...
    public function store(Request $request) {
        ...
        if ($validator->fails()) {
            if ($request->ajax()) {
                ...
                return redirect()->route('repeating_income.create')
        ...
        if (!$request->ajax()) {
            return redirect()->route('repeating_income.index')->with('success', _lang('Saved Sucessfully'));
        } else {
