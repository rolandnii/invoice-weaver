...
<head>
    ...
    <!-- App favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('uploads/media/favicon.png') }}">
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand text-md-center"
                ...
                <img src="{{asset('uploads/media/white-logo.png')}}" alt="" width="50%">
            ...
            <ul class="navbar-nav ml-auto ml-md-0">
                <li class="nav-item dropdown animate-dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                        ...
                        <a class="dropdown-item" href="{{ route('settings.show_settings_form') }}"><i
