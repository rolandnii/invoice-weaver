...
<div class="receipt">
    ...
    <div class="items">
        ...
        @foreach($transaction->invoice->invoice_items as $invoice_item)
            <div class="item-row">
...
{{--        </div>--}}
        ...
        <div class="total-row">
            ...
            <span class="price">{{$format_amount($transaction->amount)}}</span>
        </div>
...
{{--        </div>--}}
    ...
    <div class="footer small-text">
        <span>{{$transaction->reference ? '#'.$transaction->reference: ''}}</span>
