<form method="post" class="ajax-submit" autocomplete="off" action="{{ route('purchase_orders.create_payment') }}"
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control float-field"
                        value="{{ ($purchase->grand_total-$purchase->paid) }}" id="pending_amount" readOnly="true">
                </div>
            </div>
